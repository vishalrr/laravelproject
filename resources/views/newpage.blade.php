  ...
  <nav class="navbar navbar-default navbar-fixed-top">
    <div class="container"> 
      <div class="navbar-header">
        <div class="logo">
        <a href="index.html"><img src="Images/Logo (White).png" class="" alt="" /> </a>
        </div>
        </a>
      ...
      <div class="collapse navbar-collapse" id="myNavbar">
        <ul class="nav navbar-nav navbar-right">
            ...
            <li><a href="#"><button type="button" class="btn " style="padding:3px !important; font-size:12px; width: 79px;
